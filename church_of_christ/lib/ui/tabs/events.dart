  ...
  Widget _buildFeatureds(){
    List _destaque = [
      EventModel(
          ...
          urlFb: "https://www.facebook.com/acuedd",
          urlTwitter: "https://twitter.com/AcuEdd"
      ), EventModel(
          id: "1",
      ...
      pageViewBuilder: (context, visibilityResolver){
        return new PageView.builder(
          ...
          itemBuilder: (context, index){
            ...
            return new IntroNewsItem(item: _destaque[index], pageVisibility: pageVisibility, category: "Comming soon",);
          },
        );
      },
    );
